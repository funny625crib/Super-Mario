...
const int GOOMBA_MAX = 15;
	...
	public://e
		int ind;
		int index = 0;
		void Goomba_Hit_Map_Init(int map_deta,int w_,int h_);

		void Goomba_Hit_Map(Float2 map_pos);
		...
		void Update(Float2& player_pos,float player_r, bool map_move_check,bool player_janp,Float2 map_move_pos,   bool& hit_player, bool& player_enemy_hit, bool& player_enemy_jump);
		void Render();
		void Exit();
